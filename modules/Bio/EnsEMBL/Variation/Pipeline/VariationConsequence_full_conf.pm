...
sub default_options {
    ...
    return {
        ...
        fasta_dir    => undef,
        fasta_genome => $self->o('fasta_dir') ? catfile($self->o('fasta_dir'), '#species#', '#species#.fa') : undef,
        
        fasta_translation  => $self->o('species_dir').'/#species#_translations.fa',
        ...
        run_protein_function    => $self->o('run_protein_function'),
...
sub pipeline_analyses {
  ...
  my @common_params = (
    ...
    fasta_genome        => $self->o('fasta_genome'),
    fasta_translation   => $self->o('fasta_translation'),
  ...
  push @analyses, (
        ...
        {
          -logic_name => 'consequence_start',
          -module     => 'Bio::EnsEMBL::Hive::RunnableDB::Dummy',
          -meadow_type       => 'LOCAL',
          -max_retry_count => 0,
          -rc_name    => 'default',
          -flow_into  => {
            1 => WHEN('#run_protein_function#' => 'init_protein_function',
              ELSE 'transcript_effect_start'),
          },
        },
        
        {   -logic_name => 'init_protein_function',
